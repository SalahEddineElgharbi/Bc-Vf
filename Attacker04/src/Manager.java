...
public class Manager extends javax.swing.JFrame {
    ...
    static int MyPort = 6004;
    static int MinerPort = 4445;
    static int Advisor_port = 5000;
    static int confidance_c = 1;
    static boolean Attaker_51 = true;
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addGap(16, 16, 16)
                        .addComponent(label_address, javax.swing.GroupLayout.PREFERRED_SIZE, 43, javax.swing.GroupLayout.PREFERRED_SIZE)
                    ...
                    for (int k = 0; k < sizeBC; k++) {
                        ...
                        if (Attaker_51) {  
                            if (k == 2) {
                                ...
                                S1 = is.readLine();
                                S2 = is.readLine();
                                S2 = "Ｉ　ｍ　ａｔｔａｃｋｅｒ > Faked Information";
                                S3 = is.readLine();
                                S4 = is.readLine();
    ...
    class ServerThread extends Thread {
        ...
        void VTA() throws UnknownHostException, IOException {
            ...
            System.out.println("The cc of the managers:");
            ...
            for (int i = 0; i < list_managers.size(); i++) {
                if (cc_Managers.get(i) <= A_max && cc_Managers.get(i) > B_max) {
                 ...
                 System.out.println(R_C + " --------------------------------- "+ Rank_C.size());
